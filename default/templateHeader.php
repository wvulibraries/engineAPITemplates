...
<head>
	...
	@import url(https://www.libraries.wvu.edu/css/importStyles.css);
	</style>

	<!-- we don't support older browsers anymore, this styles the content -->
	<!-- that the older browsers see (content in .skipLink)               -->
	<link rel="stylesheet" href="https://www.libraries.wvu.edu/css/oldBrowsers.css" type="text/css" media="screen" />
	...
	<link rel="stylesheet" href="https://www.libraries.wvu.edu/css/dropdownMenus.css" type="text/css" media="screen" />

	<!-- Main style sheet for the interior pages -->
	<link rel="stylesheet" href="https://www.libraries.wvu.edu/css/interior.css" type="text/css" media="screen" />
	
	<!-- Handles the links in the header image -->
	<link rel="stylesheet" href="https://www.libraries.wvu.edu/css/interiorHeader.css" type="text/css" media="screen" />

	<!-- Standard 'functions'; Bold, Italic, etc ... -->
	<link rel="stylesheet" href="https://www.libraries.wvu.edu/css/standard.css" type="text/css" media="screen" />
	...
	<script src="https://www.libraries.wvu.edu/javascript/winfont.js" type="text/javascript"></script>
	<script src="https://www.libraries.wvu.edu/javascript/winFox.js" type="text/javascript"></script>

	<!-- Couple of fixes for Safari 2                                   -->
	<!-- (not worrying about safari 3 until its out of beta, not gonna  -->
	<!-- chase bugs till they are done)                                 -->
	<script src="https://www.libraries.wvu.edu/javascript/safari.js" type="text/javascript"></script>
