...
<head>
	...
	<link rel="stylesheet" href="/mike/redesign/home4/css/main.css" type="text/css" media="screen" />
	<link rel="stylesheet" href="/mike/redesign/home4/css/ui2top.css" type="text/css" media="screen" />
	
	<script src="/mike/redesign/home2/javascript/jquery.js"></script>
	<script src="/mike/redesign/home2/javascript/jquery.vscroll.js"></script>
	<script src="/mike/redesign/home2/javascript/jquery.cycle.js"></script>
	<script src="/mike/redesign/home2/javascript/jquery.easing.js"></script> 
	<script src="/mike/redesign/home2/javascript/jquery.ui2top.js" type="text/javascript"></script> 
	<script src="/mike/redesign/home2/javascript/tabs.js"></script>
	
	<script src="/mike/redesign/home2/javascript/rotate.js"></script>
	...
	<?php if ($_SERVER['PHP_SELF'] != "/mike/redesign/home2/index.php") { recurseInsert("headerIncludes.php","php"); } ?>
</head>
...
<body>
	...
	<div id="header">
		<div id="wvuMasthead">
			<a href="http://www.wvu.edu"><img src="/mike/redesign/home2/images/hp/wvu.gif" alt="WVU Logo"/></a>
		...
		<div id="libraryHeader">
			...
			<div id="siteSearch">
				Site Search: <input type="text" /> &nbsp;&nbsp; <input type="submit" value="search" />
			</div>
		</div>
