...
<html lang="en">
    <head>
        ...
        <!-- CSS -->
        <link href="/css/2014/wvu.css" type="text/css" rel="stylesheet" /> 
    ...
    <body>
        <div id="alertBar"></div>
        <div class="ask"><a href="http://answers.lib.wvu.edu/"><img title="Ask A Librarian" alt="Ask A Librarian" src="/images/2014/ask.png"></a></div>
        <header>
